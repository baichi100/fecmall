...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= $this->title ? Html::encode($this->title) : Yii::$service->page->translate->__('LIANVIN Admin Manager System') ?></title>
...
<footer class="footer">
    <div class="container">
        <div style="position:absolute;z-index: 99999;" id="footer">
            © 2015-2019
            <a style="text-decoration:none" href="http://www.li-anvin.com" target="_blank">
                <?= Yii::$service->page->translate->__('Li-Anvin Team'); ?> - www.li-anvin.com
            </a>
            <span style="padding-left:14px">
                当前版本：<a  target="_blank" href="#"><?= Yii::$service->helper->getVersion()  ?></a>
            </span>
        </div>
    </div>
</footer>
